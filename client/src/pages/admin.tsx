...
import { Plus, FileText, Shield, Bell, BarChart, AlertCircle, Scale, Send, Users, MessageSquare, Lightbulb, Database, Download, Loader2, UserCog, LogOut, DollarSign } from "lucide-react";
      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="overview" className="space-y-6">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <Card className="hover-elevate">
              <CardHeader className="flex flex-row items-center justify-between gap-2 space-y-0 pb-2">
                <CardTitle className="text-sm font-medium">Applications Activity</CardTitle>
                <FileText className="h-4 w-4 text-muted-foreground" />
              </CardHeader>
              <CardContent>
                <Link href="/admin/applications-activity" asChild>
                  <Button 
                    size="sm" 
                    className="w-full" 
                    data-testid="button-applications-activity"
                  >
                    <FileText className="h-4 w-4 mr-2" />
            ...
            <Card className="hover-elevate">
              ...
              <CardContent>
                <Link href="/admin/platform-fees" asChild>
                  <Button
                    size="sm"
                    className="w-full"
                    data-testid="button-platform-fees"
                  >
