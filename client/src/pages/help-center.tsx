    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: "Your subscription includes unlimited access to 247+ state-specific legal templates, compliance guidance cards, tenant screening resources, legal update notifications, and our credit report decoder. Everything you need to manage your rental properties with confidence."
        },
        {
