...
const comprehensiveTemplates = [
  ...
  // NEW MEXICO - Leasing
  {
    title: "New Mexico Residential Lease Agreement",
    description: "Comprehensive lease with all New Mexico disclosures including Owner Resident Relations Act requirements",
    category: "leasing" as const,
    templateType: "lease" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "Month-to-Month Agreement (NM)",
    description: "Flexible rental agreement compliant with New Mexico requirements",
    category: "leasing" as const,
    templateType: "lease" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "New Mexico Rental Application",
    description: "Fair Housing-compliant application meeting New Mexico Human Rights Act requirements",
    category: "screening" as const,
    templateType: "application" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "Adverse Action Notice (NM)",
  ...
  // NEW MEXICO - Move In/Out
  {
    title: "Move-In Inspection Form (NM)",
    description: "Property condition checklist for New Mexico rentals",
    category: "move_in_out" as const,
    templateType: "move_in_checklist" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "Move-Out Inspection Form (NM)",
    description: "Final walkthrough documentation for New Mexico properties",
    category: "move_in_out" as const,
    templateType: "move_out_checklist" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "Security Deposit Itemization (NM)",
    description: "New Mexico 30-day itemized deduction statement per Owner Resident Relations Act",
    category: "move_in_out" as const,
    templateType: "deposit_itemization" as const,
    stateId: "NM",
    version: 1,
  ...
  // NEW MEXICO - Notices
  {
    title: "3-Day Notice to Pay or Quit (NM)",
    description: "New Mexico required notice for non-payment of rent per NMSA 47-8-33",
    category: "notices" as const,
    templateType: "late_rent_notice" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "7-Day Lease Violation Notice (NM)",
    description: "Notice to cure lease violations per New Mexico law",
    category: "notices" as const,
    templateType: "lease_violation_notice" as const,
    stateId: "NM",
    version: 1,
  ...
  {
    title: "30-Day Termination Notice (NM)",
    description: "Month-to-month lease termination notice per NMSA 47-8-37",
    category: "notices" as const,
